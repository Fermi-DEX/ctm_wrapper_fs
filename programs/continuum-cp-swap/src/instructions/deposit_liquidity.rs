...
/// CPI accounts for CP-Swap deposit
#[derive(Accounts, Clone)]
pub struct CpSwapDepositAccounts<'info> {
...
pub fn deposit_liquidity(
    ...
    // CP-Swap deposit discriminator: [242, 35, 198, 137, 82, 225, 242, 182]
    ...
    // Build CPI accounts
    let cpi_accounts = CpSwapDepositAccounts {
    ...
    // Invoke the CP-Swap deposit instruction
    ...
    msg!("LP tokens requested: {}", lp_token_amount);
    msg!("Max token 0: {}", maximum_token_0_amount);
    msg!("Max token 1: {}", maximum_token_1_amount);
